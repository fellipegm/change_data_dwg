...
dwgs = glob.glob(os.path.normpath(os.path.join(current_dir, directory[0][0:-1])) + "\*.dwg")
os.system("del " + os.path.normpath(os.path.join(current_dir, directory[0][0:-1])) + "\DXF" + "/Q")
...
os.system("del " + os.path.normpath(os.path.join(current_dir, save_path)) + "\*" + "/Q")
os.system("mkdir " + os.path.normpath(os.path.join(current_dir, save_path)) + "\DXF")
# =============================================================================
...
os.system("ODAFileConverter.exe " + \
          os.path.normpath(os.path.join(current_dir, save_path, 'DXF\\')) + ' ' + \
          os.path.normpath(os.path.join(current_dir, save_path)) + ' ' + config)
os.chdir(current_dir)
